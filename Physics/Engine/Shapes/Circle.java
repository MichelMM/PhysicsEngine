...
public class Circle extends particula {
    ...
    public void proUpdate(int t, Circle c){
        ...
        if(dist<=this.getRadius()+c.getRadius()){//.0241
            ...
            /*METER ESTAS IMPRESIONES EN UN IF Y QUE SE DECIDA SI MOSTRARLAS EN OTRO LADO, VERBOSE*/
            System.out.printf("Carro1		: %f i, %f j\n",this.getPosX(),this.getPosY());
            System.out.printf("Carro2		: %f i, %f j\n",c.getPosX(),c.getPosY());
            System.out.printf("Carro1 Vel		: %f i, %f j\n",this.getVelX(),this.getVelY());
            System.out.printf("Carro2 Vel		: %f i, %f j\n",c.getVelX(),c.getVelY());
